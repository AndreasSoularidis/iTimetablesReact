...
import type { Courses, GroupEntity, TeachingEntity, TeachingPost } from "../types";
  ...
  return (
    ...
    >
      <Descriptions column={1} bordered size="small" style={{ marginBottom: 20 }}>
        ...
        <Descriptions.Item label="Δηλωμένες Ώρες Διδασκαλίας">{classTotalHours}</Descriptions.Item>
      </Descriptions>  
